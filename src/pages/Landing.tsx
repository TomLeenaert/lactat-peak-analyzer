...
const STEP_PHOTOS = [
  ...
  stepGetSetImg,
  // Test: woman running alone on athletics track at night (Jadon Johnson via Unsplash)
  'https://images.unsplash.com/photo-1726195221456-7e104a23bbff?w=600&h=420&fit=crop&auto=format&q=80',
