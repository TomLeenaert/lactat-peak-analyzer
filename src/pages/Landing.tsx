...
const COPY = {
  nl: {
    ...
    cardDemoTitle: 'Toon me hoe het werkt',
    cardDemoDesc: 'Open het demo-account met 5 echte atleten en testdata. Geen registratie.',
    cardDemoCta: 'Open onze demo-account →',
