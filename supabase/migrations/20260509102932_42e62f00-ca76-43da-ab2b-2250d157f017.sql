...
BEGIN
  ...
  SELECT jsonb_build_object(
    'totals', jsonb_build_object(
      ...
      'tests_last_30d', (SELECT COUNT(*) FROM public.test_results WHERE created_at > now() - interval '30 days'),
      'new_users_last_30d', (SELECT COUNT(*) FROM public.profiles WHERE created_at > now() - interval '30 days'),
